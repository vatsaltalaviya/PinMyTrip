  ...
  return (
    <div className="p-8" id="Explore">
      ...
      <div className="mt-10 w-full">
        <div className="  rounded-2xl w-full h-64 md:h-[40vw] relative overflow-hidden ">
          <img src="https://img.freepik.com/free-photo/big-ben-westminster-bridge-sunset-london-uk_268835-1395.jpg?ga=GA1.1.1472898491.1745146924&semt=ais_hybrid&w=740" className="w-full h-screen object-fill transform transition-transform duration-200 hover:scale-105" alt="" />
        ...
        <div className="flex flex-col md:flex-row gap-3 mt-3 ">
          <div className=" rounded-2xl w-full md:w-1/2 h-64 md:h-[40vw] overflow-hidden relative ">
            <img src="https://img.freepik.com/free-photo/beautiful-strawberry-garden-sunrise-doi-ang-khang-chiang-mai-thailand_335224-761.jpg?ga=GA1.1.1472898491.1745146924&semt=ais_hybrid&w=740" className="w-full h-screen object-fill transform transition-transform duration-200 hover:scale-105" alt="" />
            <div className="absolute bottom-10 text-white px-10">
          ...
          <div className=" rounded-2xl w-full md:w-1/2 h-64 md:h-[40vw] overflow-hidden relative">
            <img src="https://img.freepik.com/free-photo/beautiful-rustic-house-landscape_23-2151918077.jpg?ga=GA1.1.1472898491.1745146924&semt=ais_hybrid&w=740" className="w-full h-screen object-fill transform transition-transform duration-200 hover:scale-105" alt="" />
            <div className="absolute bottom-10 text-white px-10">
