  ...
  return (
    <div className="p-8" id="Explore">
      ...
      <div className="mt-10 w-full">
        <div className="  rounded-2xl w-full h-64 md:h-[40vw] relative overflow-hidden transform hover:-translate-y-2 transition-transform duration-200">
        ...
        <div className="flex flex-col md:flex-row gap-3 mt-3 ">
          <div className=" rounded-2xl w-full md:w-1/2 h-64 md:h-[40vw] overflow-hidden relative transform hover:-translate-y-2 transition-transform duration-200">
